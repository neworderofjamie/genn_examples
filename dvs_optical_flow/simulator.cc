...
int main()
{
    ...
    using Filter = DVS::CombineFilter<DVS::PolarityFilter<DVS::Polarity::ON>, DVS::ROIFilter<80, 560, 0, 480>>;
    ...
    for(i = 0; g_SignalStatus == 0; i++)
    {
...

        {
            ...
            dvs.readEvents<Parameters::inputSize, Filter, TransformX, TransformY>(spikeVectorDVS);
