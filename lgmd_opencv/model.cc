...
void modelDefinition(NNmodel &model)
{
    ...
    std::cout << "Tau p:" << tau_p << ", tau s:" << tau_s << ", tau i:" << tau_i << ", tau e:" << tau_e << ", tau lgmd:" << tau_lgmd << ", tau_f:" << tau_f << std::endl;
    ...
    // LIF initial conditions
    OpenCVLIF::VarValues opencl_lif_init(
        -60.0,        // 0 - V
        0.0);       // 1 - RefracTime
    ...
    model.addNeuronPopulation<OpenCVLIF>("P", Parameters::input_size * Parameters::input_size,
                                         p_lif_params, opencl_lif_init);
